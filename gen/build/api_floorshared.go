...
func (app *App) CreateDocumentFLOOR(parent *Internals, object *FLOOR) error {
	log.Println(*object)
...
func (app *App) UploadFLOOR(w http.ResponseWriter, r *http.Request, parent *Internals) {
...
func (app *App) floorChatGPT(user *User, parent *Internals, prompt string) error {
...
OMIT ANY NON-REQUIRED FIELDS IF NO DATA IS GENERATED FOR THE FIELD.

REPLY ONLY WITH A JSON ENCODED ARRAY OF THE GENERATED OBJECTS (NO NESTED OBJECTS, JUST OBJECTS IN A JSON ARRAY).
`,
		prompt,
	)
	...
	for _, result := range newResults {
		object := NewFLOOR(parent, FieldsFLOOR{})
