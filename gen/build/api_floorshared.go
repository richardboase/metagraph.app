...
func (app *App) floorChatGPTCreate(user *User, parent *Internals, prompt string) error {
...
func (app *App) floorChatGPTEdit(user *User, parent *Internals, object *FLOOR, prompt string) error {
