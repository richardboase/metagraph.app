...
func (app *App) petChatGPTPrompt(user *User, object *PET, prompt string) (string, error) {
...
The purpose of the object is to represent: details about a pet in the rescue center
