...
func (app *App) animalChatGPTPrompt(user *User, object *ANIMAL, prompt string) (string, error) {
...
The purpose of the object is to represent: Define the main object for storing information about each rescued animal
