...
func (app *App) gamingcarddetailsChatGPTPrompt(user *User, object *GAMINGCARDDETAILS, prompt string) (string, error) {
...
The purpose of the object is to represent: Additional details for gaming card tokens
