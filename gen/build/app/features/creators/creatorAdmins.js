...
import { CreatorObjectGET, CreatorAdminPOST } from './_fetch'

import { CreatorAdmin } from './creatorAdmin';

export function CreatorAdmins(props) {
	...
	function deleteAdmin(id) {
		...
		CreatorAdminPOST(userdata, object.Meta.ID, "remove", adminID)
		.then(function () {
			updateObject()
		}).error(function (e) {
			console.error(e)
	...
	function addAdmins() {
		newAdmins.forEach(function (admin, i) {
			CreatorAdminPOST(userdata, object.Meta.ID, "add", admin)
			.then(function () {
				updateObject()
			}).error(function (e) {
				console.error(e)
