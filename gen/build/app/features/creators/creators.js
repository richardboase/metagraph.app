...
import { CreatorList } from './shared/creatorList';
		...
		<div style={ {padding:"30px 60px 30px 60px"} } className='flex flex-col w-full'>
			<div className='flex flex-row justify-between w-full'>
				<div className='flex flex-row'>
					...
					<button id={'newcreator'} onClick={updateTabEvent} className="flex flex-col justify-center items-center cursor-pointer" style={buttonStyle}>
			...
			<AI subject={subject} updateList={updateList} collection="creators"/>
			{
				!promptToggle && <Loading/>
			}
			{
				promptToggle && <CreatorList title="Creators" subject={subject} native={true} />
			}
		</div>
	)
}