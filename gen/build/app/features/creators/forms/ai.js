...
import { CreatorsModelsPOST, CreatorsChatGPTCollectionPOST } from '../_fetch'
...
export function AI(props) {
	...
	function sendPrompt() {
		...
		case "prompt":
			...
			CreatorsModelsPOST(userdata, props.subject.Meta.ID, model, mode, payload)
			.then((res) => {
				console.log(res)
		...
		case "modify":
			CreatorsChatGPTCollectionPOST(userdata, props.subject.Meta.ID, props.collection, payload)
			.then((res) => {
				console.log(res)
				props.updateList(true)
			}) 
