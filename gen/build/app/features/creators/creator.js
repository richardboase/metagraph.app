...
import { TokenList } from '@/features/tokens/shared/tokenList'


import { CreatorObjectGET, CreatorJobPOST } from './_fetch'
...
export function Creator(props) {  
	...
	function editData() {
		setLocaldata(VisitTab(localdata, "editcreator", localdata.tab.context))
	}
    ...
    return (
		<div className='flex flex-col w-full' style={ {padding:"30px 60px 30px 60px"} }>
						...
						<tbody>
							...
							<tr className='flex flex-row'>
								...
								<td className='flex flex-col justify-start'>
									<div className='w-full flex flex-row justify-end'>
										{
											(typeof subject.fields["company"] === 'object') && <div className='flex flex-col m-4'>
												{
													Object.keys(subject.fields["company"]).forEach(function(k, i) {
														const v = subject.fields["company"][k]
														return (
															<div key={i} className='flex flex-row text-xs m-2'>
																<div className=''>{k}</div>
																<div className='px-2'>:</div>
										...
										{
											Array.isArray(subject.fields["company"]) && subject.fields["company"].map(function(item, i) {
												return (
													<div key={i} className='text-xs'>{item}</div>
												)
											})
										...
										{
											!Array.isArray(subject.fields["company"]) && !(typeof subject.fields["company"] === 'object') && <>
							...
							<tr className='flex flex-row'>
								<td className='flex flex-col justify-start'>
									<div className='w-full flex flex-row justify-end'>
										<div className='font-bold'>band</div>
									</div>
								</td>
								<td className='flex flex-col justify-start'>
									<div className='w-full flex flex-row justify-end'>
								...
								<td className='flex flex-col justify-start'>
									<div className='w-full flex flex-row justify-end'>
										{
											(typeof subject.fields["band"] === 'object') && <div className='flex flex-col m-4'>
												{
													Object.keys(subject.fields["band"]).forEach(function(k, i) {
														const v = subject.fields["band"][k]
														return (
															<div key={i} className='flex flex-row text-xs m-2'>
																<div className=''>{k}</div>
																<div className='px-2'>:</div>
										...
										{
											Array.isArray(subject.fields["band"]) && subject.fields["band"].map(function(item, i) {
												return (
													<div key={i} className='text-xs'>{item}</div>
												)
											})
										...
										{
											!Array.isArray(subject.fields["band"]) && !(typeof subject.fields["band"] === 'object') && <>
							...
							<tr className='flex flex-row'>
								<td className='flex flex-col justify-start'>
									<div className='w-full flex flex-row justify-end'>
										<div className='font-bold'>artistName</div>
									</div>
								</td>
								<td className='flex flex-col justify-start'>
									<div className='w-full flex flex-row justify-end'>
								...
								<td className='flex flex-col justify-start'>
									<div className='w-full flex flex-row justify-end'>
										{
											(typeof subject.fields["artistname"] === 'object') && <div className='flex flex-col m-4'>
												{
													Object.keys(subject.fields["artistname"]).forEach(function(k, i) {
														const v = subject.fields["artistname"][k]
														return (
															<div key={i} className='flex flex-row text-xs m-2'>
																<div className=''>{k}</div>
																<div className='px-2'>:</div>
										...
										{
											Array.isArray(subject.fields["artistname"]) && subject.fields["artistname"].map(function(item, i) {
												return (
													<div key={i} className='text-xs'>{item}</div>
												)
											})
										...
										{
											!Array.isArray(subject.fields["artistname"]) && !(typeof subject.fields["artistname"] === 'object') && <>
												
												
												{ subject.fields["artistname"] }
			...
			<div className='flex flex-col'>
				...
				<TokenList title="Tokens" subject={subject} limit={4} />
