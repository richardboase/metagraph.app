...
import { ThingObjectGET, ThingAdminPOST } from './_fetch'

import { ThingAdmin } from './thingAdmin';

export function ThingAdmins(props) {
	...
	function deleteAdmin(id) {
		...
		ThingAdminPOST(userdata, project.Meta.ID, "remove", adminID)
		.then(updateProject)
	}
	...
	function addAdmins() {
		newAdmins.forEach(function (admin, i) {
			ThingAdminPOST(userdata, project.Meta.ID, "add", admin)
			.then(updateProject)
		})
	}
