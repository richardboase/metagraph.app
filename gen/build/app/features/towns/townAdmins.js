...
import { TownObjectGET, TownAdminPOST } from './_fetch'

import { TownAdmin } from './townAdmin';

export function TownAdmins(props) {
	...
	function deleteAdmin(id) {
		...
		TownAdminPOST(userdata, project.Meta.ID, "remove", adminID)
		.then(updateProject)
	}
	...
	function addAdmins() {
		newAdmins.forEach(function (admin, i) {
			TownAdminPOST(userdata, project.Meta.ID, "add", admin)
			.then(updateProject)
		})
	}
