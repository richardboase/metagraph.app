...
import { TownObjectGET, TownUpdatePOST } from './_fetch';

import { TownEdit } from './forms/townEdit';

export function EditTown(props) {
	...
	return (
		<>
		{
			subject && <TownEdit subject={subject} submit={submitEdit}/>
		}
		</>
  	);
}
