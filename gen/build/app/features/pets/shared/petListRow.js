...
export function PetListRow(props) {
		...
		<div className='flex flex-row justify-between py-2 items-center w-full'>
			...
			<div onClick={selectItem} className='flex flex-row w-full items-center cursor-pointer px-4'>
				...
				<div className="px-4"></div>
				{
					...
					("breed" != "name") && !Array.isArray(props.item.fields["breed"]) &&  !(typeof props.item.fields["breed"] === 'object')  && <>
						<div className='text-sm font-bold' title="breed">
					...
					("medicalhistory" != "name") && !Array.isArray(props.item.fields["medicalhistory"]) &&  !(typeof props.item.fields["medicalhistory"] === 'object')  && <>
						<div className='text-sm font-bold' title="medicalhistory">
							{ props.item.fields["medicalhistory"] }
						</div>
						<div className="px-4"></div>
					</>
				}{
					("adoptionstatus" != "name") && !Array.isArray(props.item.fields["adoptionstatus"]) &&  !(typeof props.item.fields["adoptionstatus"] === 'object')  && <>
						<div className='text-sm font-bold' title="adoptionstatus">
