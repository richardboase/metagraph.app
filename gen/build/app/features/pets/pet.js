...
import { PetObjectGET, PetJobPOST } from './_fetch'
...
export function Pet(props) {  
	...
	function editData() {
		setLocaldata(VisitTab(localdata, "editpet", localdata.tab.context))
	}
						...
						<tbody>
							...
							<tr className='flex flex-row'>
								...
								<td className='flex flex-col justify-start'>
									<div className='w-full flex flex-row justify-end'>
										{
											(typeof subject.fields["breed"] === 'object') && <div className='flex flex-col m-4'>
												{
													Object.keys(subject.fields["breed"]).forEach(function(k, i) {
														const v = subject.fields["breed"][k]
														return (
															<div key={i} className='flex flex-row text-xs m-2'>
																<div className=''>{k}</div>
																<div className='px-2'>:</div>
										...
										{
											Array.isArray(subject.fields["breed"]) && subject.fields["breed"].map(function(item, i) {
												return (
													<div key={i} className='text-xs'>{item}</div>
												)
											})
										...
										{
											!Array.isArray(subject.fields["breed"]) && !(typeof subject.fields["breed"] === 'object') && <>
												
												
												{ subject.fields["breed"] }
							...
							<tr className='flex flex-row'>
								<td className='flex flex-col justify-start'>
									<div className='w-full flex flex-row justify-end'>
										<div className='font-bold'>medicalHistory</div>
									</div>
								</td>
								<td className='flex flex-col justify-start'>
									<div className='w-full flex flex-row justify-end'>
								...
								<td className='flex flex-col justify-start'>
									<div className='w-full flex flex-row justify-end'>
										{
											(typeof subject.fields["medicalhistory"] === 'object') && <div className='flex flex-col m-4'>
												{
													Object.keys(subject.fields["medicalhistory"]).forEach(function(k, i) {
														const v = subject.fields["medicalhistory"][k]
														return (
															<div key={i} className='flex flex-row text-xs m-2'>
																<div className=''>{k}</div>
																<div className='px-2'>:</div>
										...
										{
											Array.isArray(subject.fields["medicalhistory"]) && subject.fields["medicalhistory"].map(function(item, i) {
												return (
													<div key={i} className='text-xs'>{item}</div>
												)
											})
										...
										{
											!Array.isArray(subject.fields["medicalhistory"]) && !(typeof subject.fields["medicalhistory"] === 'object') && <>
												
												
												{ subject.fields["medicalhistory"] }
							...
							<tr className='flex flex-row'>
								<td className='flex flex-col justify-start'>
									<div className='w-full flex flex-row justify-end'>
										<div className='font-bold'>adoptionStatus</div>
									</div>
								</td>
								<td className='flex flex-col justify-start'>
									<div className='w-full flex flex-row justify-end'>
								...
								<td className='flex flex-col justify-start'>
									<div className='w-full flex flex-row justify-end'>
										{
											(typeof subject.fields["adoptionstatus"] === 'object') && <div className='flex flex-col m-4'>
												{
													Object.keys(subject.fields["adoptionstatus"]).forEach(function(k, i) {
														const v = subject.fields["adoptionstatus"][k]
														return (
															<div key={i} className='flex flex-row text-xs m-2'>
																<div className=''>{k}</div>
																<div className='px-2'>:</div>
										...
										{
											Array.isArray(subject.fields["adoptionstatus"]) && subject.fields["adoptionstatus"].map(function(item, i) {
												return (
													<div key={i} className='text-xs'>{item}</div>
												)
											})
										...
										{
											!Array.isArray(subject.fields["adoptionstatus"]) && !(typeof subject.fields["adoptionstatus"] === 'object') && <>
												
												
												{ subject.fields["adoptionstatus"] }
