...
export function ParagraphMatrixRow(props) {
	...
	<tr>
		...
		<td className='text-sm' style={cellStyle}>
			<div className='flex flex-row w-full ' >
				<input id="content" onFocus={cellEdit} onBlur={cellSave} className="w-full px-2" type="text" defaultValue={ props.row.fields["content"] }/>
			</div>
		</td>
	</tr>
	)
