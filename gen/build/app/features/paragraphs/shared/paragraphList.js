...
import { ParagraphListRowImage } from './paragraphListRowImage';
import { ParagraphDELETE, ParagraphsListGET, ParagraphOrderPOST, ParagraphJobPOST } from '../_fetch';


import { ChapterJobPOST } from '@/features/chapters/_fetch'
...
export function ParagraphList(props) {
	...
	function sendToTopic(e) {
		...
		ChapterJobPOST(userdata, props.subject?.Meta.ID, job)
