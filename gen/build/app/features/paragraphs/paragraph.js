...
import { ParagraphObjectGET, ParagraphJobPOST } from './_fetch'
...
export function Paragraph(props) {  
	...
	function editData() {
		setLocaldata(VisitTab(localdata, "editparagraph", localdata.tab.context))
	}
						...
						<tbody>
							...
							<tr className='flex flex-row'>
								...
								<td className='flex flex-col justify-start'>
									<div className='w-full flex flex-row justify-end'>
										{
											(typeof subject.fields["content"] === 'object') && <div className='flex flex-col m-4'>
												{
													Object.keys(subject.fields["content"]).forEach(function(k, i) {
														const v = subject.fields["content"][k]
														return (
										...
										{
											Array.isArray(subject.fields["content"]) && subject.fields["content"].map(function(item, i) {
												return (
										...
										{
											!Array.isArray(subject.fields["content"]) && !(typeof subject.fields["content"] === 'object') && <>
