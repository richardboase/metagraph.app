...
import { ClassofthingsObjectGET, ClassofthingsJobPOST } from './_fetch'

export function Classofthings(props) {  
	...
	function editData() {
		setLocaldata(VisitTab(localdata, "editclassofthings", localdata.tab.context))
	}

	function getObject() {
		ClassofthingsObjectGET(userdata, subject.Meta.ID)
		.then((res) => res.json())
		.then((data) => {
			console.log(data)
			setSubject(data)
