...
import { ClassofthingsObjectGET, ClassofthingsAdminPOST } from './_fetch'

import { ClassofthingsAdmin } from './classofthingsAdmin';

export function ClassofthingsAdmins(props) {
	...
	function deleteAdmin(id) {
		...
		ClassofthingsAdminPOST(userdata, object.Meta.ID, "remove", adminID)
		.then(function () {
			updateObject()
		}).error(function (e) {
			console.error(e)
	...
	function addAdmins() {
		newAdmins.forEach(function (admin, i) {
			ClassofthingsAdminPOST(userdata, object.Meta.ID, "add", admin)
			.then(function () {
				updateObject()
			}).error(function (e) {
				console.error(e)
