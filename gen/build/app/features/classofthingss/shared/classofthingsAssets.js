...
import { ClassofthingsAssetsRow } from './classofthingsAssetsRow';
import { ClassofthingsDELETE, ClassofthingsOrderPOST } from '../_fetch';

export function ClassofthingsAssets(props) {
	...
	}
	{
		list && list.map(function (item, i) {
			...
			return (
				<div key={i}>
					<ClassofthingsAssetsRow id={i} listLength={list.length} item={item} select={selectItem} moveUp={moveUp} moveDown={moveDown} delete={deleteItem}/>
					<Spacer/>
				</div>
			)
		})
