...
import { LobbyObjectGET, LobbyAdminPOST } from './_fetch'

import { LobbyAdmin } from './lobbyAdmin';

export function LobbyAdmins(props) {
	...
	function deleteAdmin(id) {
		...
		LobbyAdminPOST(userdata, project.Meta.ID, "remove", adminID)
		.then(updateProject)
	}
	...
	function addAdmins() {
		newAdmins.forEach(function (admin, i) {
			LobbyAdminPOST(userdata, project.Meta.ID, "add", admin)
			.then(updateProject)
		})
	}
