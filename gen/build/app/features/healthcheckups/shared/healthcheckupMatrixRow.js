...
export function HealthcheckupMatrixRow(props) {
	...
	<tr>
		...
		<td className='text-sm' style={cellStyle}>
			<div className='flex flex-row w-full ' >
				<input id="notes" onFocus={cellEdit} onBlur={cellSave} className="w-full px-2" type="text" defaultValue={ props.row.fields["notes"] }/>
			</div>
		</td>
	</tr>
	)
