...
import { HealthcheckupObjectGET, HealthcheckupMemberPOST } from './_fetch'

import { HealthcheckupMember } from './healthcheckupMember';

export function HealthcheckupMembers(props) {
	...
	function deleteAdmin(id) {
		...
		HealthcheckupMemberPOST(userdata, project.Meta.ID, "remove", adminID)
		.then(updateProject)
	}
	...
	function addAdmins() {
		newAdmins.forEach(function (admin, i) {
			HealthcheckupMemberPOST(userdata, project.Meta.ID, "add", admin)
			.then(updateProject)
		})
	}
