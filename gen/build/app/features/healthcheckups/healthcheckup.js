...
import { HealthcheckupObjectGET, HealthcheckupJobPOST } from './_fetch'

export function Healthcheckup(props) {  
	...
	function editData() {
		setLocaldata(VisitTab(localdata, "edithealthcheckup", localdata.tab.context))
	}
						...
						<tbody>
							...
							<tr className='flex flex-row'>
								...
								<td className='flex flex-col justify-start'>
									<div className='w-full flex flex-row justify-end'>
										{
											(typeof subject.fields["notes"] === 'object') && <div className='flex flex-col m-4'>
												{
													Object.keys(subject.fields["notes"]).forEach(function(k, i) {
														const v = subject.fields["notes"][k]
														return (
										...
										{
											Array.isArray(subject.fields["notes"]) && subject.fields["notes"].map(function(item, i) {
												return (
										...
										{
											!Array.isArray(subject.fields["notes"]) && !(typeof subject.fields["notes"] === 'object') && <>
												
												
												{ subject.fields["notes"] }
