...
export function HealthcheckupEdit(props) {
	...
	return (
		<div className='flex flex-col'>
			...
			<Input id="notes" type='text' required={ true } title="healthCheckup notes" placeholder="healthCheckup notes" inputChange={handleInputChange} value={ inputs["notes"].value } />
			<Spacer/>
