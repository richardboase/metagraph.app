...
import { BookObjectGET, BookMemberPOST } from './_fetch'

import { BookMember } from './bookMember';

export function BookMembers(props) {
	...
	function deleteAdmin(id) {
		...
		BookMemberPOST(userdata, project.Meta.ID, "remove", adminID)
		.then(updateProject)
	}
	...
	function addAdmins() {
		newAdmins.forEach(function (admin, i) {
			BookMemberPOST(userdata, project.Meta.ID, "add", admin)
			.then(updateProject)
		})
	}
