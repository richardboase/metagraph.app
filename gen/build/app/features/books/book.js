...
import { BookObjectGET, BookJobPOST } from './_fetch'
    ...
    return (
		<div className='flex flex-col w-full' style={ {padding:"30px 60px 30px 60px"} }>
			...
			<div className='flex flex-col'>
				...
				<BookcharacterList title="Bookcharacters" subject={subject} limit={4} />
				
				
				
				<ChapterList title="Chapters" subject={subject} limit={4} />
