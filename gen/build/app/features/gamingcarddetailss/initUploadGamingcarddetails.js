...
import { GamingcarddetailsInitUpload} from './_fetch'

export function InitUploadGamingcarddetails(props) {
	...
	function handleSubmitFile(event) {
		...
		GamingcarddetailsInitUpload(userdata, element.Meta.ID, formData)
		.then((response) => {
