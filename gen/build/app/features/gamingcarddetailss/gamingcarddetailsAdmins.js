...
import { GamingcarddetailsObjectGET, GamingcarddetailsAdminPOST } from './_fetch'

import { GamingcarddetailsAdmin } from './gamingcarddetailsAdmin';

export function GamingcarddetailsAdmins(props) {
	...
	function deleteAdmin(id) {
		...
		GamingcarddetailsAdminPOST(userdata, object.Meta.ID, "remove", adminID)
		.then(function () {
			updateObject()
		}).error(function (e) {
			console.error(e)
	...
	function addAdmins() {
		newAdmins.forEach(function (admin, i) {
			GamingcarddetailsAdminPOST(userdata, object.Meta.ID, "add", admin)
			.then(function () {
				updateObject()
			}).error(function (e) {
				console.error(e)
