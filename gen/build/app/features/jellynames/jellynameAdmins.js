...
import { JellynameObjectGET, JellynameAdminPOST } from './_fetch'

import { JellynameAdmin } from './jellynameAdmin';

export function JellynameAdmins(props) {
	...
	function deleteAdmin(id) {
		...
		JellynameAdminPOST(userdata, project.Meta.ID, "remove", adminID)
		.then(updateProject)
	}
	...
	function addAdmins() {
		newAdmins.forEach(function (admin, i) {
			JellynameAdminPOST(userdata, project.Meta.ID, "add", admin)
			.then(updateProject)
		})
	}
