...
import { JellynameObjectGET, JellynameJobPOST } from './_fetch'

export function Jellyname(props) {  
	...
	function editData() {
		setLocaldata(VisitTab(localdata, "editjellyname", localdata.tab.context))
	}
