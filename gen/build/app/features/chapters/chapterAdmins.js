...
import { ChapterObjectGET, ChapterAdminPOST } from './_fetch'

import { ChapterAdmin } from './chapterAdmin';

export function ChapterAdmins(props) {
	...
	function deleteAdmin(id) {
		...
		ChapterAdminPOST(userdata, project.Meta.ID, "remove", adminID)
		.then(updateProject)
	}
	...
	function addAdmins() {
		newAdmins.forEach(function (admin, i) {
			ChapterAdminPOST(userdata, project.Meta.ID, "add", admin)
			.then(updateProject)
		})
	}
