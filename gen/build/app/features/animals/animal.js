...
import { AnimalObjectGET, AnimalJobPOST } from './_fetch'
...
export function Animal(props) {  
	...
	function editData() {
		setLocaldata(VisitTab(localdata, "editanimal", localdata.tab.context))
	}
    ...
    return (
		<div className='flex flex-col w-full' style={ {padding:"30px 60px 30px 60px"} }>
			...
			<div className='flex flex-col'>
				...
				<HealthcheckupList title="Healthcheckups" subject={subject} limit={4} />
