...
import { GameListRowImage } from './gameListRowImage';
import { GameDELETE, GamesListGET, GameOrderPOST, GameJobPOST } from '../_fetch';
...
export function GameList(props) {
	...
	function selectChild() {
		setLocaldata(VisitTab(localdata, "games", context))
	}
