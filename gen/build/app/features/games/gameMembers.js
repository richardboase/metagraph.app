...
import { GameObjectGET, GameMemberPOST } from './_fetch'

import { GameMember } from './gameMember';

export function GameMembers(props) {
	...
	function deleteAdmin(id) {
		...
		GameMemberPOST(userdata, project.Meta.ID, "remove", adminID)
		.then(updateProject)
	}
	...
	function addAdmins() {
		newAdmins.forEach(function (admin, i) {
			GameMemberPOST(userdata, project.Meta.ID, "add", admin)
			.then(updateProject)
		})
	}
