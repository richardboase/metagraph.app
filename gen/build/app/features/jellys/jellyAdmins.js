...
import { JellyObjectGET, JellyAdminPOST } from './_fetch'

import { JellyAdmin } from './jellyAdmin';

export function JellyAdmins(props) {
	...
	function deleteAdmin(id) {
		...
		JellyAdminPOST(userdata, project.Meta.ID, "remove", adminID)
		.then(updateProject)
	}
	...
	function addAdmins() {
		newAdmins.forEach(function (admin, i) {
			JellyAdminPOST(userdata, project.Meta.ID, "add", admin)
			.then(updateProject)
		})
	}
