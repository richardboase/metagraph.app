...
export function JellyListRow(props) {
	...
	return (
		<div className='flex flex-row justify-between py-2 items-center w-full'>
			...
			<RowThumbnail source={'https://storage.googleapis.com/go-gen-test-uploads/'+props.item.Meta.Media.URIs[props.item.Meta.Media.URIs.length-1]}/>
