...
import { BookcharacterObjectGET, BookcharacterAdminPOST } from './_fetch'

import { BookcharacterAdmin } from './bookcharacterAdmin';

export function BookcharacterAdmins(props) {
	...
	function deleteAdmin(id) {
		...
		BookcharacterAdminPOST(userdata, project.Meta.ID, "remove", adminID)
		.then(updateProject)
	}
	...
	function addAdmins() {
		newAdmins.forEach(function (admin, i) {
			BookcharacterAdminPOST(userdata, project.Meta.ID, "add", admin)
			.then(updateProject)
		})
	}
