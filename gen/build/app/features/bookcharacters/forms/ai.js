...
import { BookcharactersModelsTPOST, BookcharactersChatGPTCollectionPOST } from '../_fetch'
...
export function AI(props) {
	...
	function sendPrompt() {
		...
		case "prompt":
			...
			BookcharactersModelsPOST(userdata, props.subject.Meta.ID, model, "prompt", payload)
			.then((res) => {
				console.log(res)
