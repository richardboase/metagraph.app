...
import { MusicdetailsObjectGET, MusicdetailsAdminPOST } from './_fetch'

import { MusicdetailsAdmin } from './musicdetailsAdmin';

export function MusicdetailsAdmins(props) {
	...
	function deleteAdmin(id) {
		...
		MusicdetailsAdminPOST(userdata, object.Meta.ID, "remove", adminID)
		.then(function () {
			updateObject()
		}).error(function (e) {
			console.error(e)
	...
	function addAdmins() {
		newAdmins.forEach(function (admin, i) {
			MusicdetailsAdminPOST(userdata, object.Meta.ID, "add", admin)
			.then(function () {
				updateObject()
			}).error(function (e) {
				console.error(e)
