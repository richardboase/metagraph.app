...
import { JellyList } from '@/features/jellys/shared/jellyList'
import { JellynameList } from '@/features/jellynames/shared/jellynameList'
import { LobbyList } from '@/features/lobbys/shared/lobbyList'


import { ArthurObjectGET, ArthurJobPOST } from './_fetch'

export function Arthur(props) {  
	...
	function editData() {
		setLocaldata(VisitTab(localdata, "editarthur", localdata.tab.context))
	}
    ...
    return (
		<div className='flex flex-col w-full' style={ {padding:"30px 60px 30px 60px"} }>
			...
			<div className='flex flex-col'>
				...
				<JellyList title="Jellies" subject={subject} limit={4} />
				
				
				
				<JellynameList title="Jellynames" subject={subject} limit={4} />
				
				
				
				<LobbyList title="Lobbys" subject={subject} limit={4} />
