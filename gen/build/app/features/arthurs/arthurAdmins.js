...
import { ArthurObjectGET, ArthurAdminPOST } from './_fetch'

import { ArthurAdmin } from './arthurAdmin';

export function ArthurAdmins(props) {
	...
	function deleteAdmin(id) {
		...
		ArthurAdminPOST(userdata, project.Meta.ID, "remove", adminID)
		.then(updateProject)
	}
	...
	function addAdmins() {
		newAdmins.forEach(function (admin, i) {
			ArthurAdminPOST(userdata, project.Meta.ID, "add", admin)
			.then(updateProject)
		})
	}
