...
import { FurnishingObjectGET, FurnishingAdminPOST } from './_fetch'

import { FurnishingAdmin } from './furnishingAdmin';

export function FurnishingAdmins(props) {
	...
	function deleteAdmin(id) {
		...
		FurnishingAdminPOST(userdata, project.Meta.ID, "remove", adminID)
		.then(updateProject)
	}
	...
	function addAdmins() {
		newAdmins.forEach(function (admin, i) {
			FurnishingAdminPOST(userdata, project.Meta.ID, "add", admin)
			.then(updateProject)
		})
	}
