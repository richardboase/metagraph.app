...
import { QuarterObjectGET, QuarterJobPOST } from './_fetch'
...
export function Quarter(props) {  
	...
	function editData() {
		setLocaldata(VisitTab(localdata, "editquarter", localdata.tab.context))
	}

	function sendToTopic(e) {
		console.log(e)
		const job = e.target.id
		QuarterJobPOST(userdata, subject.Meta.ID, job)
