...
import { PicturedetailsObjectGET, PicturedetailsAdminPOST } from './_fetch'

import { PicturedetailsAdmin } from './picturedetailsAdmin';

export function PicturedetailsAdmins(props) {
	...
	function deleteAdmin(id) {
		...
		PicturedetailsAdminPOST(userdata, object.Meta.ID, "remove", adminID)
		.then(function () {
			updateObject()
		}).error(function (e) {
			console.error(e)
	...
	function addAdmins() {
		newAdmins.forEach(function (admin, i) {
			PicturedetailsAdminPOST(userdata, object.Meta.ID, "add", admin)
			.then(function () {
				updateObject()
			}).error(function (e) {
				console.error(e)
