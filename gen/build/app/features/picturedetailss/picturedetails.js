...
import { PicturedetailsObjectGET, PicturedetailsJobPOST } from './_fetch'
...
export function Picturedetails(props) {  
	...
	function editData() {
		setLocaldata(VisitTab(localdata, "editpicturedetails", localdata.tab.context))
	}

	function getObject() {
		PicturedetailsObjectGET(userdata, subject.Meta.ID)
		.then((res) => res.json())
		.then((data) => {
			console.log(data)
			setSubject(data)
						...
						<tbody>
							...
							<tr className='flex flex-row'>
								...
								<td className='flex flex-col justify-start'>
									<div className='w-full flex flex-row justify-end'>
										{
											(typeof subject.fields["seriesname"] === 'object') && <div className='flex flex-col m-4'>
												{
													Object.keys(subject.fields["seriesname"]).forEach(function(k, i) {
														const v = subject.fields["seriesname"][k]
														return (
										...
										{
											Array.isArray(subject.fields["seriesname"]) && subject.fields["seriesname"].map(function(item, i) {
												return (
										...
										{
											!Array.isArray(subject.fields["seriesname"]) && !(typeof subject.fields["seriesname"] === 'object') && <>
												
												
												{ subject.fields["seriesname"] }
							...
							<tr className='flex flex-row'>
								...
								<td className='flex flex-col justify-start'>
									<div className='w-full flex flex-row justify-end'>
										{
											(typeof subject.fields["imagetitle"] === 'object') && <div className='flex flex-col m-4'>
												{
													Object.keys(subject.fields["imagetitle"]).forEach(function(k, i) {
														const v = subject.fields["imagetitle"][k]
														return (
															<div key={i} className='flex flex-row text-xs m-2'>
																<div className=''>{k}</div>
																<div className='px-2'>:</div>
										...
										{
											Array.isArray(subject.fields["imagetitle"]) && subject.fields["imagetitle"].map(function(item, i) {
												return (
													<div key={i} className='text-xs'>{item}</div>
												)
											})
										...
										{
											!Array.isArray(subject.fields["imagetitle"]) && !(typeof subject.fields["imagetitle"] === 'object') && <>
												
												
												{ subject.fields["imagetitle"] }
							...
							<tr className='flex flex-row'>
								<td className='flex flex-col justify-start'>
									<div className='w-full flex flex-row justify-end'>
										<div className='font-bold'>pictureUrl</div>
									</div>
								</td>
								<td className='flex flex-col justify-start'>
									<div className='w-full flex flex-row justify-end'>
								...
								<td className='flex flex-col justify-start'>
									<div className='w-full flex flex-row justify-end'>
										{
											(typeof subject.fields["pictureurl"] === 'object') && <div className='flex flex-col m-4'>
												{
													Object.keys(subject.fields["pictureurl"]).forEach(function(k, i) {
														const v = subject.fields["pictureurl"][k]
														return (
															<div key={i} className='flex flex-row text-xs m-2'>
																<div className=''>{k}</div>
																<div className='px-2'>:</div>
										...
										{
											Array.isArray(subject.fields["pictureurl"]) && subject.fields["pictureurl"].map(function(item, i) {
												return (
													<div key={i} className='text-xs'>{item}</div>
												)
											})
										...
										{
											!Array.isArray(subject.fields["pictureurl"]) && !(typeof subject.fields["pictureurl"] === 'object') && <>
												
												
												{ subject.fields["pictureurl"] }
