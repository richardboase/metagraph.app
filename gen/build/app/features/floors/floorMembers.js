...
import { FloorObjectGET, FloorMemberPOST } from './_fetch'

import { FloorMember } from './floorMember';

export function FloorMembers(props) {
	...
	function deleteAdmin(id) {
		...
		FloorMemberPOST(userdata, project.Meta.ID, "remove", adminID)
		.then(updateProject)
	}
	...
	function addAdmins() {
		newAdmins.forEach(function (admin, i) {
			FloorMemberPOST(userdata, project.Meta.ID, "add", admin)
			.then(updateProject)
		})
	}
