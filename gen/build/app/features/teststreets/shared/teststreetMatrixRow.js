...
export function TeststreetMatrixRow(props) {
	...
	<tr>
		...
		<td className='text-sm' style={cellStyle}>
			...
			<div className='flex flex-row w-full ' >
				<input id="start" onFocus={cellEdit} onBlur={cellSave} className="w-full px-2" type="text" defaultValue={ props.row.fields["start"] }/>
			</div>
		</td><td className='text-sm' style={cellStyle}>
			<div className='flex flex-row w-full ' >
				<input id="end" onFocus={cellEdit} onBlur={cellSave} className="w-full px-2" type="text" defaultValue={ props.row.fields["end"] }/>
			</div>
		</td>
	</tr>
	)
