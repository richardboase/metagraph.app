...
import { TeststreetObjectGET, TeststreetJobPOST } from './_fetch'
						...
						<tbody>
							...
							<tr className='flex flex-row'>
								...
								<td className='flex flex-col justify-start'>
									<div className='w-full flex flex-row justify-end'>
										{
											(typeof subject.fields["start"] === 'object') && <div className='flex flex-col m-4'>
												{
													Object.keys(subject.fields["start"]).forEach(function(k, i) {
														const v = subject.fields["start"][k]
														return (
															<div key={i} className='flex flex-row text-xs m-2'>
																<div className=''>{k}</div>
																<div className='px-2'>:</div>
										...
										{
											Array.isArray(subject.fields["start"]) && subject.fields["start"].map(function(item, i) {
												return (
													<div key={i} className='text-xs'>{item}</div>
												)
											})
										...
										{
											!Array.isArray(subject.fields["start"]) && !(typeof subject.fields["start"] === 'object') && <>
							...
							<tr className='flex flex-row'>
								...
								<td className='flex flex-col justify-start'>
									<div className='w-full flex flex-row justify-end'>
										{
											(typeof subject.fields["end"] === 'object') && <div className='flex flex-col m-4'>
												{
													Object.keys(subject.fields["end"]).forEach(function(k, i) {
														const v = subject.fields["end"][k]
														return (
															<div key={i} className='flex flex-row text-xs m-2'>
																<div className=''>{k}</div>
																<div className='px-2'>:</div>
										...
										{
											Array.isArray(subject.fields["end"]) && subject.fields["end"].map(function(item, i) {
												return (
													<div key={i} className='text-xs'>{item}</div>
												)
											})
										...
										{
											!Array.isArray(subject.fields["end"]) && !(typeof subject.fields["end"] === 'object') && <>
