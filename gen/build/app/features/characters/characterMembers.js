...
import { CharacterObjectGET, CharacterMemberPOST } from './_fetch'

import { CharacterMember } from './characterMember';

export function CharacterMembers(props) {
	...
	function deleteAdmin(id) {
		...
		CharacterMemberPOST(userdata, project.Meta.ID, "remove", adminID)
		.then(updateProject)
	}
	...
	function addAdmins() {
		newAdmins.forEach(function (admin, i) {
			CharacterMemberPOST(userdata, project.Meta.ID, "add", admin)
			.then(updateProject)
		})
	}
