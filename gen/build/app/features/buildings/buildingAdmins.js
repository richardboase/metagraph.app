...
import { BuildingObjectGET, BuildingAdminPOST } from './_fetch'

import { BuildingAdmin } from './buildingAdmin';

export function BuildingAdmins(props) {
	...
	function deleteAdmin(id) {
		...
		BuildingAdminPOST(userdata, project.Meta.ID, "remove", adminID)
		.then(updateProject)
	}
	...
	function addAdmins() {
		newAdmins.forEach(function (admin, i) {
			BuildingAdminPOST(userdata, project.Meta.ID, "add", admin)
			.then(updateProject)
		})
	}
