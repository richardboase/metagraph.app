...
export function BuildingMatrix(props) {
	...
	function newobject() {
		setLocaldata(VisitTab(localdata, "newbuilding", localdata.tab.context))
	}
	...
	<>
	{
		...
		<table className='w-full'><tbody>
			<tr>
				...
				<td className='font-bold px-2' style={cellStyle}>name</td><td className='font-bold px-2' style={cellStyle}>description</td><td className='font-bold px-2' style={cellStyle}>number</td><td className='font-bold px-2' style={cellStyle}>xunits</td><td className='font-bold px-2' style={cellStyle}>yunits</td><td className='font-bold px-2' style={cellStyle}>floors</td><td className='font-bold px-2' style={cellStyle}>doors</td>
			</tr>
			{
