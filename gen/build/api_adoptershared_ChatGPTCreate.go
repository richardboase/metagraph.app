...
func (app *App) adopterChatGPTCreate(user *User, parent *ADOPTER, prompt string) error {
...
We want to create one or more of these data objects: information about an adopter
