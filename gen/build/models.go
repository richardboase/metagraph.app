...
func (x *ADOPTER) Schema() *models.Object {
	obj := &models.Object{}
	json.Unmarshal([]byte(`{"name":"adopter","names":null,"plural":"adopters","json":"","context":"Stores information about individuals who adopt animals","fields":[{"id":"adopter-name","context":"The name of the adopter","name":"adopter name","type":"person.name","element":"none","inputs":[{"id":"first-name","context":"A name or names of something or someone","name":"first-name","type":"name","element":"input","inputReference":"","required":true,"filter":false,"range":{"min":2,"max":50},"regexp":"","regexpHex":""},{"id":"middle-names","context":"A name or names of something or someone","name":"middle-names","type":"name","element":"input","inputReference":"","required":false,"filter":false,"range":{"min":2,"max":50},"regexp":"","regexpHex":""},{"id":"last-name","context":"A name or names of something or someone","name":"last-name","type":"name","element":"input","inputReference":"","required":true,"filter":false,"range":{"min":2,"max":50},"regexp":"","regexpHex":""}],"inputReference":"","required":true,"filter":false,"regexp":"","regexpHex":""},{"id":"adopter-phone-number","context":"The phone number of the adopter","name":"adopter phone number","type":"phone","element":"phone","inputReference":"","required":true,"filter":false,"regexp":"^\\+?[1-9]\\d{1,14}$","regexpHex":"5e5c2b3f5b312d395d5c647b312c31347d24"}],"listMode":"","options":{"readonly":false,"admin":true,"member":null,"job":false,"comment":false,"order":false,"file":false,"image":false,"photo":false,"exif":false,"font":false,"topicCreate":null,"topics":null,"assetlayer":null,"handcash":{"Type":"","Payments":null,"Mint":null},"pusher":false,"permissions":{"AdminsOnly":false,"AdminsEdit":false},"filterFields":null},"tags":null,"childTags":null}`), obj)
	return obj
}
