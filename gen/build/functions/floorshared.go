...
func (app *App) CreateDocumentFLOOR(parent *models.Internals, object *models.FLOOR) error {
	log.Println(*object)
...
func (app *App) UploadFLOOR(w http.ResponseWriter, r *http.Request, parent *models.Internals) {
	...
	*/
	...
	fields := models.FieldsFLOOR{}
	floor := models.NewFLOOR(parent, fields)
...
func (app *App) UploadArchiveFLOOR(w http.ResponseWriter, r *http.Request, parent *models.Internals) {
