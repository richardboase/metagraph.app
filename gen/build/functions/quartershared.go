...
func (app *App) CreateDocumentQUARTER(parent *models.Internals, object *models.QUARTER) error {
	log.Println(*object)
...
func (app *App) UploadQUARTER(w http.ResponseWriter, r *http.Request, parent *models.Internals) {
...
func (app *App) UploadArchiveQUARTER(w http.ResponseWriter, r *http.Request, parent *models.Internals) {
