...
func (app *App) CreateDocumentBUILDING(parent *models.Internals, object *models.BUILDING) error {
	log.Println(*object)
...
func (app *App) UploadBUILDING(w http.ResponseWriter, r *http.Request, parent *models.Internals) {
	...
	*/
	...
	fields := models.FieldsBUILDING{}
	building := models.NewBUILDING(parent, fields)
...
func (app *App) UploadArchiveBUILDING(w http.ResponseWriter, r *http.Request, parent *models.Internals) {
