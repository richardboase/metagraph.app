...
func (app *App) CreateDocumentROOM(parent *models.Internals, object *models.ROOM) error {
	log.Println(*object)
...
func (app *App) UploadROOM(w http.ResponseWriter, r *http.Request, parent *models.Internals) {
	...
	*/
	...
	fields := models.FieldsROOM{}
	room := models.NewROOM(parent, fields)
...
func (app *App) UploadArchiveROOM(w http.ResponseWriter, r *http.Request, parent *models.Internals) {
