...
func (app *App) CreateDocumentTOWN(parent *models.Internals, object *models.TOWN) error {
	log.Println(*object)
...
func (app *App) UploadTOWN(w http.ResponseWriter, r *http.Request, parent *models.Internals) {
	...
	*/
	...
	fields := models.FieldsTOWN{}
	town := models.NewTOWN(parent, fields)
...
func (app *App) UploadArchiveTOWN(w http.ResponseWriter, r *http.Request, parent *models.Internals) {
