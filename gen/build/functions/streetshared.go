...
func (app *App) CreateDocumentSTREET(parent *models.Internals, object *models.STREET) error {
	log.Println(*object)
...
func (app *App) UploadSTREET(w http.ResponseWriter, r *http.Request, parent *models.Internals) {
	...
	*/
	...
	fields := models.FieldsSTREET{}
	street := models.NewSTREET(parent, fields)
...
func (app *App) UploadArchiveSTREET(w http.ResponseWriter, r *http.Request, parent *models.Internals) {
