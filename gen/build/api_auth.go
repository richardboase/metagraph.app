...
func (app *App) AuthEntrypoint(w http.ResponseWriter, r *http.Request) {
	...
	case "GET":
		...
		case "otp":
			...
			subject := "MAGIC LINK for BSVMint"
			...
			htmlContent := fmt.Sprintf(
				...
				<br/>
				<a href='http://localhost:3000/home?p=BSVMint&otp=%s'>Debug</a>
				<br/>
				<br/>
				<a href='https://newtown.vercel.app/home?p=BSVMint&otp=%s'>Click here to Login</a>
				`,
				secret,
				secret,
			)
