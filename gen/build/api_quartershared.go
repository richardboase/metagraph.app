...
func (app *App) quarterChatGPTCreate(user *User, parent *Internals, prompt string) error {
...
func (app *App) quarterChatGPTEdit(user *User, parent *Internals, object *QUARTER, prompt string) error {
