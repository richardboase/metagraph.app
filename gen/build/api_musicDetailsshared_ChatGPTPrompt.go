...
func (app *App) musicdetailsChatGPTPrompt(user *User, object *MUSICDETAILS, prompt string) (string, error) {
...
The purpose of the object is to represent: Additional details for music tokens
