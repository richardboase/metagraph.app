...
func (app *App) thingChatGPTPrompt(user *User, object *THING, prompt string) (string, error) {
...
The purpose of the object is to represent: a distinct ant transferrable object of any size, could be anything
