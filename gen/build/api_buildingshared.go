...
func (app *App) buildingChatGPTCreate(user *User, parent *Internals, prompt string) error {
...
The purpose of the object is to represent: A building which exists in a street, could be residential, commercial, or industrial.
...
func (app *App) buildingChatGPTEdit(user *User, parent *Internals, object *BUILDING, prompt string) error {
