...
func (app *App) CreateDocumentBOOK(parent *Internals, object *BOOK) error {
	log.Println(*object)
...
func (app *App) UploadBOOK(w http.ResponseWriter, r *http.Request, parent *Internals) {
...
func (app *App) ArchiveUploadBOOK(w http.ResponseWriter, r *http.Request, parent *Internals) {
...
func (app *App) bookChatGPTCreate(user *User, parent *Internals, prompt string) error {
...
The purpose of the object is to represent: a creative writing project
...
`
	...
	for _, r := range newResults {
		...
		object := NewBOOK(parent, FieldsBOOK{})
		if err := object.ValidateObject(result); err != nil {
			return err
		}
		if err := app.CreateDocumentBOOK(parent, object); err != nil {
			return err
		}
...
func (app *App) bookChatGPTEdit(user *User, parent *Internals, object *BOOK, prompt string) error {
