...
func (app *App) addPicturedetailsAdmin(object *PICTUREDETAILS, admin string) error {
...
func (app *App) removePicturedetailsAdmin(object *PICTUREDETAILS, admin string) error {
