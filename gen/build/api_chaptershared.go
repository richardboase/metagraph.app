...
func (app *App) UploadCHAPTER(w http.ResponseWriter, r *http.Request, parent *Internals) {
	...
	*/
	...
	chapter := NewCHAPTER(parent, fields)
...
func (app *App) ArchiveUploadCHAPTER(w http.ResponseWriter, r *http.Request, parent *Internals) {
...
func (app *App) chapterChatGPTCreate(user *User, parent *Internals, prompt string) error {
