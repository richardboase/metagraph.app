...
func (app *App) creatorChatGPTEdit(user *User, parent *CREATOR, prompt string) error {
...
The purpose of the object is to represent: Information about the token creator
