...
func (app *App) teststreetChatGPTCreate(user *User, parent *Internals, prompt string) error {
...
func (app *App) teststreetChatGPTEdit(user *User, parent *Internals, object *TESTSTREET, prompt string) error {
