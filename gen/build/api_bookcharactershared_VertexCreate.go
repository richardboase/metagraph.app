...
func (app *App) bookcharacterVertexCreate(user *User, parent *BOOKCHARACTER, prompt string) error {
...
We want to create one or more of these data objects: a character that will be involved with the storyline, or who might impact a central character but be passive in nature
