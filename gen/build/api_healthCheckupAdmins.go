...
func (app *App) addHealthcheckupAdmin(object *HEALTHCHECKUP, admin string) error {
...
func (app *App) removeHealthcheckupAdmin(object *HEALTHCHECKUP, admin string) error {
