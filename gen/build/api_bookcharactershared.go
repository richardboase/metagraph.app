...
func (app *App) CreateDocumentBOOKCHARACTER(parent *Internals, object *BOOKCHARACTER) error {
	log.Println(*object)
	...
	*/
	...
	// write new BOOKCHARACTER to the DB
...
func (app *App) bookcharacterChatGPTCreate(user *User, parent *Internals, prompt string) error {
...
`
	...
	for _, r := range newResults {
		...
		object := NewBOOKCHARACTER(parent, FieldsBOOKCHARACTER{})
...
func (app *App) bookcharacterChatGPTEdit(user *User, parent *Internals, object *BOOKCHARACTER, prompt string) error {
