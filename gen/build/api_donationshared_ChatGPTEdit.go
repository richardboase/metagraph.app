...
func (app *App) donationChatGPTEdit(user *User, parent *DONATION, prompt string) error {
...
The purpose of the object is to represent: record of a donation made to the rescue center
