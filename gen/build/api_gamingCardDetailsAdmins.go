...
func (app *App) addGamingcarddetailsAdmin(object *GAMINGCARDDETAILS, admin string) error {
...
func (app *App) removeGamingcarddetailsAdmin(object *GAMINGCARDDETAILS, admin string) error {
