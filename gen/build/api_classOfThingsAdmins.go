...
func (app *App) addClassofthingsAdmin(object *CLASSOFTHINGS, admin string) error {
...
func (app *App) removeClassofthingsAdmin(object *CLASSOFTHINGS, admin string) error {
