...
func (app *App) picturedetailsChatGPTPrompt(user *User, object *PICTUREDETAILS, prompt string) (string, error) {
...
The purpose of the object is to represent: Additional details for picture tokens
