...
func (app *App) streetChatGPTCreate(user *User, parent *Internals, prompt string) error {
...
func (app *App) streetChatGPTEdit(user *User, parent *Internals, object *STREET, prompt string) error {
