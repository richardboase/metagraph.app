...
func (app *App) streetChatGPT(user *User, parent *Internals, prompt string) error {
...
The purpose of the object is to represent: A street, part of the transaportation network of a town or city.
...
`,
	...
	for _, result := range newResults {
		object := NewSTREET(parent, FieldsSTREET{})
