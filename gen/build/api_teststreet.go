...
// api-teststreet
func (app *App) EntrypointTESTSTREET(w http.ResponseWriter, r *http.Request) {
...
func (app *App) getTeststreetList(subject *TESTSTREET) []*TESTSTREET {
	list := []*TESTSTREET{}
